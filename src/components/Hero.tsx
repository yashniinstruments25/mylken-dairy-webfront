...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center bg-gradient-to-br from-mylken-primary via-mylken-primary/95 to-mylken-dark overflow-hidden">
      {/* Animated Background Elements */}
      <div className="absolute inset-0 z-0">
        {/* Floating geometric shapes */}
        <div className="absolute top-20 right-20 w-96 h-96 bg-mylken-accent/10 rounded-full blur-3xl animate-float"></div>
        <div className="absolute bottom-20 left-20 w-80 h-80 bg-mylken-secondary/15 rounded-full blur-3xl animate-float animation-delay-500"></div>
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10 pt-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center min-h-[80vh]">
          ...
          <div className="space-y-8 text-left animate-fade-in">
            {/* Trust Badge */}
            <div className="inline-flex items-center gap-3 bg-mylken-accent/20 backdrop-blur-sm px-6 py-3 rounded-full border border-mylken-accent/30 shadow-sm animate-slide-in-left">
              <div className="w-2 h-2 bg-mylken-accent rounded-full animate-pulse"></div>
              <span className="text-sm font-medium text-mylken-accent">Dairy Processing Innovation</span>
              <div className="flex items-center gap-1 ml-4 text-mylken-light/80">
            ...
            <div className="space-y-6 animate-slide-in-left animation-delay-300">
              <h1 className="text-5xl lg:text-7xl font-bold leading-tight text-white">
                Transform Your
                <span className="block text-mylken-accent relative">
                  Dairy Production
                  <div className="absolute -bottom-2 left-0 w-32 h-1 bg-mylken-accent/60 rounded-full animate-pulse"></div>
                </span>
              ...
              <p className="text-xl lg:text-2xl text-mylken-light/90 leading-relaxed max-w-2xl">
            ...
            <div className="flex flex-wrap gap-6 animate-slide-in-left animation-delay-500">
              {[
                ...
                >
                  <CheckCircle className="w-5 h-5 text-mylken-accent" />
                  <span className="text-mylken-light font-medium">{feature}</span>
                </div>
              ))}
            </div>

            {/* CTA Buttons with hover animations */}
            <div className="flex flex-col sm:flex-row gap-4 pt-6 animate-slide-in-left animation-delay-700">
              <Link to="/products">
                <Button 
                  size="xl" 
                  className="bg-mylken-accent text-mylken-dark hover:bg-mylken-accent/90 px-10 py-6 text-lg font-semibold rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 group"
                >
                  Browse Equipment
              ...
              <Link to="/contact">
                <Button 
                  variant="outline" 
                  size="xl"
                  className="border-2 border-mylken-light/30 text-mylken-light hover:bg-mylken-light/10 hover:border-mylken-light/50 px-10 py-6 text-lg font-semibold rounded-xl backdrop-blur-sm transition-all duration-300"
                >
          ...
          {/* Right Content - Elegant Dashboard/Analytics Mockup */}
          <div className="relative flex items-center justify-center animate-slide-in-right">
            <div className="relative">
              {/* Main Dashboard Container */}
              <div className="relative bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-8 max-w-lg animate-float">
                {/* Header */}
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center gap-3">
                    <div className="w-3 h-3 bg-mylken-accent rounded-full"></div>
              ...
              <div className="absolute -top-4 -left-4 bg-white rounded-xl p-3 shadow-lg border border-mylken-accent/20 animate-float animation-delay-300">
              ...
              {/* Subtle Glow Effect */}
              <div className="absolute inset-0 bg-mylken-accent/10 blur-3xl rounded-3xl scale-110 -z-10 animate-pulse"></div>
            </div>
          </div>
        </div>
      </div>
