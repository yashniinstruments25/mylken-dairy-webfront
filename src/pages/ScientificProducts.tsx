...
const ScientificProducts = () => {
  ...
  const scientificProducts = getProductsByCategory('Scientific Products');
    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-grow pt-20">
          ...
          <div className="container-custom">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="text-lg text-gray-600 mb-8">
                Laboratory-grade scientific instruments for precise measurements and analysis. 
                Professional equipment for research and quality control applications.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-12">
          <div className="container-custom">
            <h2 className="text-3xl font-bold text-mylken-dark mb-8">Laboratory Equipment</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {scientificProducts.map(({ id, product }) => (
